...
class SMSService {
  ...
  formatPhoneNumber(phoneNumber) {
    ...
    throw new Error(
      `Invalid phone number format: ${phoneNumber}. Use Australian format (04XXXXXXXX) or international format.`
    );
  }
    ...
    try {
      ...
      if (!this.isConfigured()) {
        ...
        return {
          success: false,
          error:
            "SMS service not configured. Check SMS_USERNAME, SMS_PASSWORD, and SMS_SENDER environment variables.",
        };
      }
